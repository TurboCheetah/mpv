...
local osc_styles = {
    ...
    rjno150Buttons = "{\\blur0\\bord0\\1c&Heeeeee\\3c&Hd4d4d4\\fs24\\fnmpv-osd-symbols}",
    rjno140Buttons = "{\\blur0\\bord0\\1c&Heeeeee\\3c&Hd4d4d4\\fs16\\fnmpv-osd-symbols}",
    rjno130Buttons = "{\\blur0\\bord0\\1c&Heeeeee\\3c&Hd4d4d4\\fs24\\fnmpv-osd-symbols}",
    rjno125Buttons = "{\\blur0\\bord0\\1c&Heeeeee\\3c&Hd4d4d4\\fs29\\fnmpv-osd-symbols}",
    rjno120Buttons = "{\\blur0\\bord0\\1c&Heeeeee\\3c&Hd4d4d4\\fs24\\fnmpv-osd-symbols}",
    rjno116Buttons = "{\\blur0\\bord0\\1c&Heeeeee\\3c&Hd4d4d4\\fs16\\fnmpv-osd-symbols}",
    rjno11line1 = "{\\blur0\\bord0\\1c&H101010\\3c&Hd4d4d4\\fs16\\fnmpv-osd-symbols}",
    ...
    rjno1wcButtons = "{\\1c&Hd4d4d4\\fs24\\fnmpv-osd-symbols}",
    rjno1wcTitle = "{\\1c&Hd4d4d4\\fs18\\q2}",
    rjno1wcBar = "{\\1c&H101010}",
